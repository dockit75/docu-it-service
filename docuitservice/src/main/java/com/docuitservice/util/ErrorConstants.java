...
public class ErrorConstants {
	...
	public static final String INVALID_INPUT = "Please provide a valid request";
	...
	public static final String USER_ID_IS_INVALID = "Please provide valid User id";
	public static final String MEMBER_ID_INVALID = "Please provide valid Member id";
	public static final String FAMILY_IS_INVALID = "Please provide valid Family id";
	public static final String CATEGORY_IS_INVALID = "Category id is invalid or null";
	public static final String DOCUMENT_NAME_IS_INVALID = "Please provide valid Document name";
	public static final String DOCUMENT_URL_IS_INVALID = "Please provide valid Document url";
	public static final String DOCUMENT_SIZE_IS_INVALID = "Document size is invalid";
	public static final String DOCUMENT_IS_INVALID = "Please provide valid Document id";
	public static final String MEMBER_ALREADY_RESPONDED = "Member already responded to Inivte";
	public static final String DOCUMENT_TYPE_IS_NULL= "Please provide valid Document Type";
	public static final String EXTERNAL_INVITE_IS_INVALID= "Please provide valid invite id";

...
public class CategoryController {
	...
	public Response getCategoriesByUserId(@PathVariable("userId") String userId) throws Exception {
		return categoryService.getCategoriesByUserId(userId);
	}

	@GetMapping("/find/user/{userId}/category/{categoryId}")
	public Response userCategoryDocuments(@PathVariable("userId") String userId,
			@PathVariable("categoryId") String categoryId) throws Exception {
		return categoryService.userCategoryDocuments(userId, categoryId);
	}

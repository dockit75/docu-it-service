...
public class AuthRestAPIs {
	...
	public Response resendOtp(@RequestParam String email) throws Exception {
	...
	@PostMapping("/login")
	public Response login(@RequestParam String deviceId, @RequestParam String password) throws Exception {
		return authService.login(deviceId, password);
	}
